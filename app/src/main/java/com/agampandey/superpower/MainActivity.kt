...
import com.agampandey.superpower.service.FloatingService
import com.agampandey.superpower.util.PermissionUtil
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var historyAdapter: com.agampandey.superpower.ui.HistoryAdapter
    private lateinit var historyManager: com.agampandey.superpower.util.HistoryManager
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        historyManager = com.agampandey.superpower.util.HistoryManager(this)
        ...
        findViewById<android.view.View>(R.id.btn_privacy).setOnClickListener {
            val intent = Intent(this, com.agampandey.superpower.ui.PolicyActivity::class.java)
    ...
    private fun setupHistory() {
        historyAdapter = com.agampandey.superpower.ui.HistoryAdapter { item ->
    ...
    private fun setupLanguageSpinner() {
        ...
        languageSpinner.onItemSelectedListener = object : android.widget.AdapterView.OnItemSelectedListener {
             override fun onItemSelected(parent: android.widget.AdapterView<*>, view: android.view.View?, position: Int, id: Long) {
                 ...
                 // Pre-emptive Download
                 Toast.makeText(this@MainActivity, "Preparing ${selectedName} model in background...", Toast.LENGTH_SHORT).show()
                 lifecycleScope.launch(kotlinx.coroutines.Dispatchers.IO) {
                      val tm = com.agampandey.superpower.core.TranslationManager(this@MainActivity)
                      tm.downloadLanguageModel(code ?: "en")
                 }
             }
